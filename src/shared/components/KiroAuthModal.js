...
export default function KiroAuthModal({ isOpen, onMethodSelect, onClose }) {
  ...
  // IDC/org tokens need clientId+clientSecret from auto-import for refresh
    ...
    const autoDetect = async () => {
      ...
      try {
        ...
        if (data.found) {
          ...
          // Persist IDC/organization credentials if auto-import resolved them
    ...
    try {
      const res = await fetch("/api/oauth/kiro/import", {
        ...
        body: JSON.stringify({
          ...
          // Forward IDC client registration so enterprise tokens refresh correctly
          ...(idcCredentials || {}),
        }),
      });
            ...
            <div className="bg-blue-50 dark:bg-blue-900/20 p-3 rounded-lg border border-blue-200 dark:border-blue-800">
              <div className="flex gap-2">
                ...
                <p className="text-sm text-blue-800 dark:text-blue-200">
                  ...
                  against AWS and stored directly as a bearer credential (no
                  refresh).
                </p>
              </div>
            </div>
