/**
 * Free-tier providers (may require account/API key but offer free access).
 * @module providers/free-tier-providers
 */
...
export const FREE_TIER_PROVIDERS = {
  ...
  nvidia: {
    ...
    ttsConfig: {
      ...
      format: "nvidia-tts",
      models: [
        { id: "fastpitch", name: "FastPitch" },
        { id: "tacotron2", name: "Tacotron2" },
      ],
    },
    embeddingConfig: {
