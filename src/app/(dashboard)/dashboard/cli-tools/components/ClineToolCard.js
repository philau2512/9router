...
export default function ClineToolCard({
  ...
  const [selectedModel, setSelectedModel] = useState(
    () => initialStatus?.settings?.openAiModelId || "",
  );
  ...
  const getManualConfigs = () => {
    ...
    const baseWithoutV1 = effectiveUrl.endsWith("/v1")
      ? effectiveUrl.slice(0, -3)
      : effectiveUrl;
      ...
      >
        <div className="flex min-w-0 items-center gap-3">
          <div className="size-8 flex items-center justify-center shrink-0">
            <Image src="/providers/cline.png" alt={tool.name} width={32} height={32} className="size-8 object-contain rounded-lg" sizes="32px" loading="lazy" decoding="async" onError={(e) => { e.currentTarget.style.display = "none"; }} />
          </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-text-muted">
                      Manual configuration is still available if 9router is
                ...
                <div className="p-4 bg-surface border border-border rounded-lg">
                  ...
                  <div className="space-y-3 text-sm">
                    <p className="text-text-muted">
                      Install Cline VS Code extension or CLI from{" "}
                      <a
