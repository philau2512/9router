...
This project is indexed by GitNexus as **9router** (14124 symbols, 28943 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
