...
const mocks = vi.hoisted(() => ({
  ...
  logApiKeyPresence: vi.fn(),
  normalizeApiKeyFailureLog: vi.fn(),
  getSettings: vi.fn(),
  getCombos: vi.fn(),
...
vi.mock("@/sse/services/auth.js", () => ({
  ...
  getApiKeyValue: mocks.getApiKeyValue,
  logApiKeyPresence: mocks.logApiKeyPresence,
  normalizeApiKeyFailureLog: mocks.normalizeApiKeyFailureLog,
}));
...
describe("web fetch account state", () => {
  beforeEach(() => {
    ...
    mocks.enforceApiKeyPolicy.mockResolvedValue({ ok: true, auth: null });
    mocks.getApiKeyValue.mockReturnValue(null);
