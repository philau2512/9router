...
describe("tokenRefresh public barrel", () => {
  it("re-exports refreshKimiToken from its implementation module", async () => {
    const barrel = await import("open-sse/services/tokenRefresh.js");
    const implementation = await import("open-sse/services/tokenRefresh/providers.js");

    expect(barrel.refreshKimiToken).toBe(implementation.refreshKimiToken);
  });
});
