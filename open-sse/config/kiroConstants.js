...
1. Write/edit max 300 lines per operation.
2. For new large files (>300 lines), write the initial 300 lines first, then append.
3. For existing files, apply surgical edits instead of rewriting the entire file.
4. Large operations may exceed the 2-3 minute server timeout and fail.
5. Small, incremental operations are preferred.
`.trim();
